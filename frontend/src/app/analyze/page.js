...
import { Activity, ArrowLeft, Download, ShieldCheck, PieChart as PieChartIcon, Network, FileText } from "lucide-react";
...
export default function AnalyzePage() {
    ...
    useEffect(() => {
        ...
        if (data) {
            ...
            // For demo: if accessed directly without submission, go back
            router.push("/");
        }
    }, [router]);
    ...
    return (
        <div className="max-w-7xl mx-auto pb-20 space-y-8 animate-in fade-in duration-700">
            ...
            {/* Hero Summary */}
            <AnalysisSummary config={{}} result={result} onDownloadCam={handleDownload} />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="glass-card p-6 rounded-2xl flex flex-col justify-between">
                            ...
                            <div className="pt-4 mt-6 border-t border-slate-800 text-center text-xs text-slate-500">
                                Blend: Financial (25%) + PD (30%) + Ext. Risk (45%)
                            </div>
                        </div>
                        ...
                        <div className="glass-card p-6 rounded-2xl flex flex-col justify-between">
                            <div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex justify-between items-center pb-2 border-b border-slate-800">
                                        <span className="text-sm text-slate-400">News Sentiment (NLP)</span>
                ...
                <div className="lg:col-span-4 space-y-6">
                    ...
                    <div className="glass-panel p-6 rounded-2xl flex flex-col items-center justify-center text-center space-y-4">
                        ...
                        <button
                            ...
                            className="w-full py-3 rounded-lg bg-slate-800 hover:bg-slate-700 text-white font-medium flex justify-center items-center gap-2 border border-slate-600 transition-colors"
                        >
