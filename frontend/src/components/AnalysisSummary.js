        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center md:items-start justify-between gap-6">
          ...
          <div className="flex flex-col gap-3 min-w-[200px]">
            <button
              ...
              className="px-6 py-3 rounded-xl font-bold bg-white text-slate-900 hover:bg-blue-50 transition flex items-center justify-center gap-2 shadow-xl shadow-white/5 disabled:opacity-60"
            >
